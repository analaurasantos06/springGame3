package com.senai.analaura.prjGame.controllers;
...
import com.senai.analaura.prjGame.services.JogoService;
...
public class JogoController {
	...
	/*
	 * @GetMapping public List<Jogo> getAllJogo() { return jogoService.getAllJogo();
	 * }
	 */
	@GetMapping("/{id}")
